...
<table border="0" cellspacing="0" cellpadding="12" width="100%">
  <tr>
    ...
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:computer: Languages</strong></p>
    ...
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:bookmark_tabs: Frameworks</strong></p>
  ...
  <tr>
    ...
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:hammer_and_wrench: IDEs</strong></p>
  ...
  <tr>
    <!-- ROW 3: Databases & Monitoring -->
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:floppy_disk: Databases</strong></p>
    ...
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:bar_chart: Monitoring and Observability</strong></p>
  ...
  <tr>
    <!-- ROW 4: Containers & IaC -->
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:package: Containerization and Orchestration</strong></p>
    ...
    <td valign="top" width="50%">
      <p style="border-bottom:1px solid #d0d7de;padding-bottom:8px;margin-bottom:10px;"><strong>:scroll: Infrastructure as Code (IaC)</strong></p>
      <img alt="Terraform" title="Terraform" src="https://github.com/Karimangfn/Karimangfn/blob/main/Images/Terraform.png" height="45"/>
    </td>
  </tr>
  <tr>
    <!-- ROW 5: DevOps & Artifacts -->
    <td valign="top" width="50%">
