...
<table border="0" cellspacing="0" cellpadding="8" style="width: 100%;" width="100%">
  <!-- Definição explícita de largura para as 6 colunas base da tabela -->
  <colgroup>
  ...
  <tr>
    <!-- ROW 5: AI Tools, Management & Admin — 50% split (3 cols + 3 cols) -->
